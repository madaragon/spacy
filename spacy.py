...
class spacy:
    def __init__(self):
        self.search_params = {'query': '', 'state': ''}
        self.search_spaceids_params = {'ids': ''}
        self.search_creatorid_params = {'user_ids': ''}
    ...
    def connect_to_space_lookup_with_spaceids(self):
        ...
        self.params.update(**self.search_spaceids_params,
                           **self.expansions,
                           **self.spacefield)
    ...
    def connect_to_space_lookup_with_creatorids(self):
        ...
        self.params.update(**self.search_creatorid_params,
                           **self.spacefield,
                           **self.expansions)
